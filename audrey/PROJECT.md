...
Six unique trackables are expected for this family (the supplied seven inputs contained one duplicate). The app derives actual totals from JSON; duplicate public IDs produce an explicit error instead of inflating totals. Current real snapshot: six coins, two with history and four without logged travels. The app never invents waiting-coin locations.
